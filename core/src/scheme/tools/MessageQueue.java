...
/**
 * Очередь чат-сообщений с ограничением темпа - защита от кика за спам, когда SlashJs
 * шлёт пачку /js команд (у клиента есть ratelimit-учёт только для конфигов, не для чата).
 * Портировано из Scheme Size как есть.
 */
