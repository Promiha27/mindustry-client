...
public class Binding{
    ...
    tile_actions_menu_modifier = KeyBind.add("tile_actions_menu_modifier", KeyCode.altLeft, "client"),
    freecam_modifier = KeyBind.add("freecam_modifier", KeyCode.altLeft),
    reset_camera = KeyBind.add("reset_camera", KeyCode.r),
    place_waypoint = KeyBind.add("place_waypoint", KeyCode.y),
    drop_payload = KeyBind.add("drop_payload", KeyCode.backslash),
    navigate_to_cursor = KeyBind.add("navigate_to_cursor", KeyCode.z),
    stop_following_path = KeyBind.add("stop_following_path", KeyCode.minus),
    show_turret_ranges = KeyBind.add("show_turret_ranges", KeyCode.backtick),
    hide_blocks = KeyBind.add("hide_blocks", KeyCode.i),
    invisible_units = KeyBind.add("invisible_units", KeyCode.o),
    show_reactor_and_dome_ranges = KeyBind.add("show_reactor_and_dome_ranges", KeyCode.f9),
    toggle_placement_modifiers = KeyBind.add("toggle_placement_modifiers", KeyCode.shiftLeft),
    chat_autocomplete = KeyBind.add("chat_autocomplete", KeyCode.tab),
    auto_build = KeyBind.add("auto_build", KeyCode.semicolon),
    auto_repair = KeyBind.add("auto_repair", KeyCode.l),
    auto_mine = KeyBind.add("auto_mine", KeyCode.k),
    toggle_strict_mode = KeyBind.add("toggle_strict_mode", KeyCode.f7),
    find_modifier = KeyBind.add("find_modifier", KeyCode.controlLeft),
