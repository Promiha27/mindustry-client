...
class ChunkedFrameBuffer(
  ...
  companion object {
    //universe.util.reflect.accessField (UniverseKit) -> arc Reflect: поле protected static в GLFrameBuffer
    private val currentBuffer: GLFrameBuffer<*>? get() = arc.util.Reflect.get(GLFrameBuffer::class.java, null, "currentBoundFramebuffer")
