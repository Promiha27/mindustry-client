...
public class SchematicsTableUi{
    ...
    static class CellIconsElement extends Element{
         ...
         * значка (доля контент/значок ≈ 1.15). Раз в сетке контент растить некуда - вместо этого
         * ужимаем значки до той же пропорции относительно потолка контента: 0.49/1.15 ≈ 0.40.
         */
        static final float GRID_FRAC_GLYPH = 0.40f;
        /**
